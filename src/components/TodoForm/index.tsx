...
const { theme } = useContext(ThemeContext);
    ...
    return (
        <form className="relative mb-10" onSubmit={addTodo}>
            ...
            <input type="text" placeholder="Create a new todo..." name="task" className={`${themeConfig[theme].todo.backgroundColor} w-full ${themeConfig[theme].todo.textColor} rounded-md py-6 pl-16 outline-none text-lg`}/>
        </form>
    )
}
